        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Reabir Episodios (sin alta registrada)
                    </h5>
                ...
                <div class="modal-body">
                    <p>Este módulo se usa para reabrir episodios los cuales no contengan un perfil de alta registrado y esten cerrados.</p>
                    <p><b>*Los programas, por ejemplo los Ley 22 que los episodios cierran al registrar una admisión estos no son elegibles para reabrir*</b></p>
