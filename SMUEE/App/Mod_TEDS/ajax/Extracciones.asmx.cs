    ...
    public class Extracciones : System.Web.Services.WebService
    {
        ...
        public byte[] GenerateExcel(string file, DateTime min, DateTime max, int[] programs)
        {
            ...
            try
            {
                ...
                string[] headerAD = {"SysTranType","StateCode","ReportDate","ProviderID","ClientID","CoDep","ClientTransType","DateAdmission","Services","NumPriorTreat","PrinSrcRef","DateBirth",
                ...
                string[] headerDIS = { "SysTransTyp", "StateCode", "ReportDate", "ProviderID", "ClientID", "CoDep", "Services", "DateLastContact", "DateDischarge", "RsnDischarge", "AdmProviderID", "AdmClientID", "AdmCoDep", "AdmClientTransTyp", "DateAdmission", "AdmServices", "DateBirth", "Gender", "Race", "Ethnicity", "SubProb1", "SubProb2"
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    switch (file)
                    {
                        ...
                        //var rep = File(stream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", $"{file} {min.ToString("yyyy-MM-dd")} al {max.ToString("yyyy-MM-dd")}.xlsx");
