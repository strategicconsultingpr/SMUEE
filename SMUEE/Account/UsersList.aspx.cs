    ...
    public partial class UsersList : System.Web.UI.Page
    {
        ...
        private void getUsersList()
        {
            ...
            try
            {
                ...
                {
                    var usersList = dsSMUEE.VW_UsersList.Where(a => a.PK_Usuario != Usuario.Id).DefaultIfEmpty().ToList();

                    if (userManager.IsInRole(Usuario.Id, "Administrador"))
                    {
                        usersList = usersList.Where(a => a.Rol != "SuperAdmin").DefaultIfEmpty().ToList();
                    }
