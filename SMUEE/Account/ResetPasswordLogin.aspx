<%@ Page Title="" Language="C#" MasterPageFile="~/NoLogin.Master" AutoEventWireup="true" CodeBehind="ResetPasswordLogin.aspx.cs" Inherits="SMUEE.Account.ResetPasswordLogin" %>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        <div class="card-body">
                            <div class="small mb-3 text-muted">
                                ...
                                <div class="form-group">
                                    <asp:Label runat="server" AssociatedControlID="OldPassword" CssClass="col-md-2 control-label">Contraseña Actual</asp:Label>
                                    <div class="col-md-10">
